-- GlobalPulse Intelligence — CockroachDB Schema Setup
-- Run this once in your CockroachDB SQL shell or Console to create all tables
-- CockroachDB SQL shell: cockroach sql --url "YOUR_CONNECTION_STRING"
